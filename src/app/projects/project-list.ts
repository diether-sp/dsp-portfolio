export const PROJECT_LIST = [
    ...
    },
    {
      ...
      responsibilities: [
        "Designed and developed a ground up REST API for web and mobile applications",
        "Implement microservices",
    ...
    },
    {
      ...
      responsibilities: [
        "Developed a REST API for web and mobile applications",
        "Implemented remote services",
    ...
    },
    {
      ...
      responsibilities: [
        "Designed and developed a ground up REST API for web application",
        "Lead backend team",
        "Implemented Unit Testing"
      ],
    ...
    },
    {
      ...
      responsibilities: [
        "Designed and developed a ground up REST API for web and mobile applications",
        "Implemented Keycloak as an authentication provider",
    ...
    },
    {
      ...
      desc: 'An electicity management application that enables users to track electricity usage, access billing information, and manage their accounts across Visayas and Mindanao through a clean and user-friendly interface.',
      technologies: [
        "Java",
        "Springboot",
        "Oracle",
      ...
      responsibilities: [
        ...
        "Implemented microservices",
        "Created configmaps for dev/staging/prod deployment"
      ],
